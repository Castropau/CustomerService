...
<div class="date-time">
  ...
  <a class="active"href="customerservice.php">Guest List Report</a>
  ...
  <div style="background-color: white; font-family: Calibri(body); width: 145vh;"class="col-md-12">
    <div style="width: 150%;"class="panel-body">
        <?php 
            include "dbconn.php";
            $query = "SELECT * FROM guest ORDER BY amount DESC";
            ...
            <table class="table table-bordered" id="table-bordered">
                ...
                <?php 
                    ...
                    while($row = mysqli_fetch_array($result)){ 
                        $guest_quantity = $row['amount'];
                        if($prev_quantity != null && $prev_quantity > $guest_quantity) {
                            $rank++;
                        }
                        $prev_quantity = $guest_quantity;
                ?>
                    <tr class="td">                        
                        <!-- <td><?php echo $rank; ?></td> -->
                        <td><?php echo $row['id']; ?></td>
                        <td><?php echo $row['guest_name']; ?></td>                        
                        <td><?php echo $guest_quantity; ?></td>                            
                    </tr>
